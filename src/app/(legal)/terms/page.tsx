const TermsPage = () => {
  return (
    <div className="p-4">
      ...
      <p>Welcome to Smart FinTrack!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Smart FinTrack's Website, located at http://localhost:3000.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Smart FinTrack if you do not agree to
      ...
      <p>
        ...
        subject to, prevailing law of pk. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Smart FinTrack, you agreed to
        use cookies in agreement with the Smart FinTrack's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Smart FinTrack and/or its licensors own the
        intellectual property rights for all material on Smart FinTrack. All
        intellectual property rights are reserved. You may access this from
        Smart FinTrack for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Smart FinTrack</li>
        <li>Sell, rent or sub-license material from Smart FinTrack</li>
        <li>Reproduce, duplicate or copy material from Smart FinTrack</li>
        <li>Redistribute content from Smart FinTrack</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Smart
        FinTrack does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Smart FinTrack,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Smart FinTrack
      ...
      <p>
        Smart FinTrack reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Smart FinTrack a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Smart FinTrack; and (d) the
      ...
      <p>
        ...
        e-mail to Smart FinTrack. Please include your name, your organization
      ...
      <p>
        No use of Smart FinTrack's logo or other artwork will be allowed for
