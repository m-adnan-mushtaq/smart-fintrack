const page = () => {
  return (
    <div className="p-4">
      ...
      <h1 className="text-4xl font-bold">Interpretation and Definitions</h1>
      <h2 className="text-3xl font-bold">Interpretation</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Smart FinTrack.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Smart FinTrack, accessible from{" "}
            <a
      ...
      <h1 className="text-4xl font-bold">Collecting and Using Your Personal Data</h1>
      <h2 className="text-3xl font-bold">Types of Data Collected</h2>
      ...
      <h3 className="text-2xl font-bold">Information from Third-Party Social Media Services</h3>
      <p>
      ...
      <h2 className="text-3xl font-bold">Retention of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-3xl font-bold">Transfer of Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-3xl font-bold">Delete Your Personal Data</h2>
      <p>
      ...
      <h2 className="text-3xl font-bold">Disclosure of Your Personal Data</h2>
      <h3 className="text-2xl font-bold">Business Transactions</h3>
      <p>
      ...
      <h3 className="text-2xl font-bold">Law enforcement</h3>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="text-2xl font-bold">Other legal requirements</h3>
      <p>
      ...
      <h1 className="text-4xl font-bold">Children's Privacy</h1>
      <p>
      ...
      <h1 className="text-4xl font-bold">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="text-4xl font-bold">Changes to this Privacy Policy</h1>
      <p>
      ...
      <ul>
        <li>
          <p>By email: madnandeveloper@gmail.com</p>
        </li>
        <li>
          <p>
